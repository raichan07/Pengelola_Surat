                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#tambahModal" style="margin-bottom: 5px">
                                    Tambah
                                </button>
                                <a href="{{ route('klasifikasi.export') }}" class="btn btn-info" style="margin-bottom: 5px">Export Klasifikasi Data</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal{{ $let['id'] }}">Hapus</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
