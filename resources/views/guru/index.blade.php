                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="{{ route('guru.createGuru') }}" type="button"></a>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" style="float: right; margin-left: 10px;">Tambah
                                    Data</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('guru.storeGuru') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <label for="user">Masukan Email</label>
                                    </div>
                ...
                @foreach ($users as $user)
                    <div class="modal fade" id="editModal{{ $user->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <form action="{{ route('guru.updateGuru', $user->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="form-floating">
                                            <input type="text" name="name" class="form-control mt-2" id="name"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('guru.deleteGuru', $user->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
