                        ...
                        <div class="card-body">
                            ...
                            @if (Auth::check())
                                @if (Auth::user()->role == 'staff')
                                    <a href="{{ route('letters.create') }}" class="btn btn-primary">Tambah </a>
                                    <a href="{{ route('letters.export') }}" class="btn btn-success">Export Data Surat</a>
                                @endif
                            @endif
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    @foreach ($letters as $key => $letter)
                                        <tr>
                                            ...
                                            <td>
                                            <ol>
                                            @foreach ($letter['recipients'] as $item)
                                            <li>{{ $item}}</li>
                                            @endforeach
                                            </ol>
                                            </td>
